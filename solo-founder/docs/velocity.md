...
For a one-person company, the largest recoverable waste is not typing speed. It is **time spent deciding things that did not deserve the time** — and you have a whole calendar for that waste to expand into.
