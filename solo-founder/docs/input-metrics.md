...
A one-person company does the reverse almost universally, and has all day to. Revenue, signups, stars, followers — none of which you can act on directly — sit one tab away. Opening the dashboard feels like starting work.

**Checking an output metric is not work. It produces no decision and it costs the block you were going to ship in.**
