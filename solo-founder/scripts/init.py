#!/usr/bin/env python3
"""Scaffold the .mechanisms/ state directory for the solo-founder skill.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Scaffold .mechanisms/ for the solo-founder skill."
    )
    parser.add_argument(
...
print("Start with RESUME.md — fill it with this morning's one outcome.")
